...
- **With upstream research** — if `.arsenal/strategy/research/MARKET_RESEARCH.md` exists (from `market-analysis`), this skill uses it as context. The spec lands grounded in the executive dossier's findings.
...
#### Path A — `.arsenal/strategy/research/MARKET_RESEARCH.md` exists
